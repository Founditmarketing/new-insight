      ...
      <div className="relative z-20 w-full max-w-5xl mx-auto flex flex-col items-center text-center mt-12">
        ...
        <h1 className="text-[10vw] sm:text-[4rem] lg:text-[5.5rem] text-paper mb-6 flex flex-col font-bold tracking-tighter leading-[1] relative z-20">
          ...
          <motion.span 
            ...
            className="block text-[#FF4D5E] drop-shadow-[0_0_40px_rgba(227,38,54,0.5)]"
          >
            Protection.
          </motion.span>
        </h1>
        ...
        >
          We shop dozens of carriers to find coverage that fits your life — at a price that makes sense. No sales pitch, just honest help.
        </motion.p>
        ...
        >
          <button onClick={onOpenQuote} className="group relative px-8 py-5 bg-accent hover:bg-white text-white hover:text-accent font-bold tracking-widest uppercase text-sm hidden sm:flex items-center justify-center shadow-[0_0_40px_rgba(227,38,54,0.4)] transition-all duration-500 overflow-hidden w-full sm:w-auto">
